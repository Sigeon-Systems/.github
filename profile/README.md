## Sigeon Systems
We build Sigeon related stuff like SigeonOS with (possibly) Frutigo Areo style.
<br>
Our official website at [os.sigeon.xyz](https://os.sigeon.xyz). <br>
Which is also where you can download our operating system, SigeonOS. <br>
Make sure that while joining Sigeon System, please do not cause drama or join with drama. <br>

### If you're a part of the Sigeon Systems. Read da rules:
1. Dont cause drama (as explained) <br>
2. Dont upload malicious programs. We do not tolerate that. <br>
3. Dont set or publish private projects unless permitted by the owner (of the repo.) <br>
4. Have common sense. <br>
<sub>Breaking them are punishable from a warning, to getting kicked out.<sub> <br>
<br>
